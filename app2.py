...
if st.button('Record'):
    ...
    st.session_state.audio_file_path = save_audio(audio, sample_rate)
...
if st.session_state.audio_file_path:
    ...
    user_input = input_placeholder.text_input(label="Enter Prompt", label_visibility="hidden", placeholder="Ask a question about the audio:", key="question_input", value="")
